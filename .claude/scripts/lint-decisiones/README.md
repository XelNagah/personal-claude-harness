...
**Cómo se corre:** `node .claude/scripts/lint-decisiones/lint-decisiones.js` (desde la raíz del repo). Acepta una carpeta como argumento (default `.claude/decisiones`).
**Estado:** vigente.
