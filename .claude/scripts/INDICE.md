...
| [lint-memoria](lint-memoria/) | Lint de la memoria local: refs/wikilinks rotos, `MEMORIA.md` incompleto, huérfanos, frontmatter inválido | `node .claude/scripts/lint-memoria/lint-memoria.js` | vigente |
| [lint-preferencias](lint-preferencias/) | Lint estructural de preferencias: secciones Base/Adaptaciones + `@import` en CLAUDE.md | `node .claude/scripts/lint-preferencias/lint-preferencias.js` | vigente |
| [lint-planes](lint-planes/) | Lint del ciclo de planes (estados data-driven de `ESTADOS.md`): estado↔carpeta, sueltos, estados inválidos, cierres a medias, activos (`En curso`) envejecidos | `node .claude/scripts/lint-planes/lint-planes.js` | vigente |
...
| [lint-harness](lint-harness/) | Lint de coherencia del harness: disco↔marketplace↔REGISTRO, junctions, verbatim divergente entre plantillas | `node .claude/scripts/lint-harness/lint-harness.js` | vigente |
