...
| [lint-memoria](lint-memoria/) | Lint de la memoria local: refs/wikilinks rotos, `MEMORY.md` incompleto, huérfanos, frontmatter inválido | `node .claude/scripts/lint-memoria/lint-memoria.js` | vigente |
