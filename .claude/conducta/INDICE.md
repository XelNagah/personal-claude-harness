...
| Base-0011 | Avisar cuando el contexto de la sesión se puso pesado | Mide el transcript de la sesión como aproximación del contexto y, pasado el umbral, propone un punto de corte; nunca frena nada | cada turno | Bloquear | conducta/avisar-contexto-pesado/avisar-contexto-pesado.js --umbral 150000 | vigente | — |
