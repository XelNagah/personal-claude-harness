...
- [Despliegue de plugins y migraciones](despliegue-de-plugins-claude-code.md) — paradas y desfases de una versión; diferencias entre Codex y Claude Code; prueba sobre un consumidor viejo; cierre por hash remoto, registros activos, control completo y agente recién iniciado.
