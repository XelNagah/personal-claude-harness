...
**Por qué:** ubicación determinística → el lint y cualquier consulta saben dónde mirar sin heurística; separa lo que el agente conoce de la configuración y de sus Herramientas; mantiene la raíz del repo limpia.
