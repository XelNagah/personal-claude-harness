...
**Cómo se corre:** `node .claude/conocimiento/lint-conocimiento/lint-conocimiento.js` (desde la raíz del repo). Acepta una carpeta como argumento (default `.claude/conocimiento`).
**Estado:** vigente.
