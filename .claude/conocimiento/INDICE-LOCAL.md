...
| Local-0013 | Controles que dejan de controlar sin avisar | Trece formas en que un control se apaga: valida un conjunto vacío, mira una copia, nadie lo probó, mide una entrada mutilada, agrupa otros, fabrica medio escenario, o su banco lee el repo autor. | [controles-que-no-avisan.md](controles-que-no-avisan.md) |
