...
| Local-0013 | Controles que dejan de controlar sin avisar | Las nueve formas en que un control se apaga: valida sobre un conjunto vacío, se quedó sin población, mira una copia, nadie lo probó, o mide una entrada mutilada y contesta en rojo. Cómo probarlo. | [controles-que-no-avisan.md](controles-que-no-avisan.md) |
