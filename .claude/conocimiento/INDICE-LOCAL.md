...
| Local-0013 | Controles que dejan de controlar sin avisar | Doce formas en que un control se apaga: valida sobre un conjunto vacío, mira una copia, nadie lo probó, mide una entrada mutilada, agrupa a otros, o fabrica medio escenario y el entorno pone el resto. | [controles-que-no-avisan.md](controles-que-no-avisan.md) |
