...
| Local-0013 | Controles que dejan de controlar sin avisar | Las seis formas en que un control se apaga solo y sigue dando verde: valida sobre un conjunto vacío, marca tanto que se lo deja de leer, mira una copia y no la que se usa, nadie lo probó nunca, tiene adentro una condición que no controla nada, o se quedó sin población que controlar. Incluye cómo se prueba un control y por qué reportar y fallar son contratos distintos. | [controles-que-no-avisan.md](controles-que-no-avisan.md) |
