...
| Local-0013 | Controles que dejan de controlar sin avisar | Las cinco formas en que un control se apaga solo y sigue dando verde: valida sobre un conjunto vacío, marca tanto que se lo deja de leer, mira una copia y no la que se usa, nadie lo probó nunca, o tiene adentro una condición que no controla nada. Incluye cómo se prueba un control y por qué reportar y fallar son contratos distintos. | [controles-que-no-avisan.md](controles-que-no-avisan.md) |
