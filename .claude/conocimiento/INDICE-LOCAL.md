...
| Local-0013 | Controles que dejan de controlar sin avisar | Las diez formas en que un control se apaga: valida sobre un conjunto vacío, mira una copia, nadie lo probó, mide una entrada mutilada, o agrupa a otros y cubre menos de lo que promete. Cómo probarlo. | [controles-que-no-avisan.md](controles-que-no-avisan.md) |
