...
| Agente Multipropósito | Setup estándar que sirve a cualquier propósito con el mismo patrón de subsistemas: el usuario define el propósito y los subsistemas se llenan hacia él. Es el harness particular que este repo **mantiene y distribuye** —subsistemas, funcionalidades/plugins y marketplace—. Da nombre al proyecto: **AMP** es la abreviación de *Agente Multipropósito* (una sola palabra, decisión 0014). "Harness" es el término genérico —un setup de subsistemas cualquiera—; en este repo **denota** el AMP: no todo harness es un AMP, pero todo AMP es un harness. | AMP, MPA, Multipurpose Agents, Agente, harness, setup estándar | — | — |
| Subsistema | Área del harness que persiste estado siguiendo el patrón índice + entradas + lint (memoria, conocimiento, semántica, decisiones, planes, herramientas). | subsistema de acumulación | — | — |
