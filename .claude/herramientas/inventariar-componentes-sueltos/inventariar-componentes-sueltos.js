#!/usr/bin/env node
// inventariar-componentes-sueltos.js — Frente B del plan "Que el harness tenga efecto conductual".
// El punto ciego: los 8 lints solo miran ADENTRO de su propio subsistema; nada reportaba lo
// que quedó afuera. Este chequeo cierra la mitad barata: barre `.claude/` y lista los componentes
...
const sueltos = [];     // { nombre, motivo } — componentes sin subsistema ni infra
