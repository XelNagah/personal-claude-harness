...
- **Refresco de autoría** (hueco de 0013) → desprendido a [Control de desfase entre el harness en disco y el plugin cargado](../pendientes/Control%20de%20desfase%20entre%20el%20harness%20en%20disco%20y%20el%20plugin%20cargado.md). Sigue abierto y hoy pesa: esta máquina está del lado plugin, así que el repo que autora el harness lo consume como si fuera ajeno.
