...
- **Alcance de agentes.** ¿Solo Claude Code, o también Codex CLI por la paridad que fija la Decisión Local-0010 (arquitectura multiagente con AGENTS.md)? Un script que lanza `claude` por nombre no sirve para Codex; parametrizar el ejecutable es barato si se decide temprano.
