...
1. **Alcance del control.** ¿Cubre solo asentar en `decisiones/INDICE.md` (paridad literal con el glosario), o también afirmar decisiones en otras piezas — planes, resúmenes, mensajes? El incidente que motiva el plan cae en el segundo grupo; el primero no lo hubiera evitado. **Tercer grupo (evidencia 26-07-24, ver nota abajo): redefinir o remover una entrada YA canónica**, no solo asentar una nueva. Los controles actuales (preámbulo glosario "toda entrada nueva pasa por el usuario", decisiones 0004/0016/0018) gatean el alta; ninguno gatea la baja ni la modificación de contenido de algo ya ratificado, y 0020 hasta exime como mantenimiento cierta clase de cambios. La regla del usuario a cubrir: *"preguntar antes de redefinir/remover algo canónico"*.
