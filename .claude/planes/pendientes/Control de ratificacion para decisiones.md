...
1. **Alcance del control.** ¿Cubre solo asentar en `decisiones/INDICE.md` (paridad literal con el glosario), o también afirmar decisiones en otras piezas — planes, resúmenes, mensajes? El incidente que motiva el plan cae en el segundo grupo; el primero no lo hubiera evitado.
