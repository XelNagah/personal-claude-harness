...
- Portabilidad: los repos consumidores reciben el lint por instalador; el cambio a config no puede romper el actualizar.
...
Alto: rediseño estructural que toca los ocho lints, su distribución y el actualizar de todos los repos consumidores. No arrancar sin resolver las preguntas abiertas. Es la generalización correcta, pero es su propio proyecto — no bloquea los arreglos puntuales.
