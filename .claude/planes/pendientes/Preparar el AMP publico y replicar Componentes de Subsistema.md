...
- **Probar una instalación limpia**, que es el criterio de cierre número uno de este plan y todavía no se ejecutó: verificar contra un repo vacío que no lleguen fechas argentinas, prohibición de analogías deportivas, estilo de commits ni criterio de idioma.
