...
**Estado: Diferido · Creado 26-07-21.** Pedido de Javier: publicar el proyecto en GitHub **en inglés** para llegar a un público mayor. Surgió en la sesión del Manifiesto (Decisión Local-0017, modelo de carga de contexto por subsistema). **Diferido a propósito:** se hace cuando el harness esté bien pulido, no antes — migrar el idioma sobre un diseño que todavía se mueve es trabajo que se rehace.
