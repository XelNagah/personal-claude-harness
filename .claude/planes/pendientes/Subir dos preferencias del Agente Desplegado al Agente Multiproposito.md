...
1. La entrada sale de `PREFERENCIAS-LOCAL.md` y entra en `PREFERENCIAS.md` con un código nuevo (`Base-0014`, `Base-0015`): el prefijo es el origen, así que promover cambia el código y la referencia vieja muere. Está previsto en la decisión 0043.
