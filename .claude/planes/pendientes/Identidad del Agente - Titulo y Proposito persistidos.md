...
- **Captura:** el setup la pregunta al inicializar (toca el orquestador `inicializar-custom` + `inicializar-memoria-local`/la memoria inicial). Para repos ya existentes: queda indefinida hasta el próximo actualizado.
