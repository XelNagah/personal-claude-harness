...
| 0004 | **Gobernanza de terminología:** el agente no acuña términos del dominio por cuenta propia; prefiere las palabras del usuario. Gate duro en registros canónicos (glosario, decisiones): ningún término acuñado se asienta sin ratificación. En prosa se usa marcado como propuesto. (Motivada por un término inventado — "sustrato" — que se coló al glosario/decisión antes de que el usuario lo corrigiera.) | 2026-07-18 | vigente | — |
