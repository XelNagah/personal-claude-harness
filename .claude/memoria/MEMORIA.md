...
- [Flujo de planes](feedback_flujo_planes.md) — planes en `.claude/planes/` (pendientes/ejecutados/descartados) con registro `PLANES.md` y estados en `ESTADOS.md` (máquina de un eje); slug estable, estado y fechas en el registro; lint al cerrar.
