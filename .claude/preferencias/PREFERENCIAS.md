...
- **Al comparar alternativas, no contar como costo de una opción algo que ya está comprometido en todas.** Si el trabajo se va a hacer igual por otro motivo, es precio ya pagado: sumarlo a una sola opción la hace ver artificialmente cara y empuja la decisión hacia el lado equivocado. (Candidato a subir a Base y propagar al harness: es un criterio universal de comparación, no específico de este repo.)
- **Al enumerar** tres o más elementos en una respuesta, presentarlos en **lista de bullets**, no en una sola línea de texto corrido — es más fácil de escanear que un párrafo donde todo pesa igual. (Candidato a subir a Base y propagar al harness: es estilo universal, no específico de este repo.)
