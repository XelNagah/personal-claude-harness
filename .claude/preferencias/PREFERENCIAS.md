...
| Base-0015 | Buscar una solución existente antes de escribir una propia | Antes de escribir código propio para un problema, buscar —incluido en internet— si ya existe una biblioteca, una función nativa del lenguaje o una solución estándar del ecosistema que lo resuelva. Lo escrito a mano hereda los defectos que la solución madura ya tapó y queda sin nadie que lo mantenga. **Buscar no obliga a adoptar**: en lo que se distribuye a otros repos una dependencia nueva es un costo para quien la instale, y la solución propia puede ganar. Lo que no se saltea es la búsqueda ni su resultado: decir qué se encontró y por qué se usa o no. | — |
| Base-0016 | Nombrar qué es cada código al citarlo | Los códigos `Base-NNNN` y `Local-NNNN` se repiten entre registros: el mismo código puede ser una decisión, un plan, una preferencia, una página de conocimiento, una Herramienta o un término del glosario. Al citar una entrada —en la conversación y en lo que queda escrito— el código nunca va solo: lo precede qué es. «la Decisión Local-0047», «el plan Local-0088», «el conocimiento Local-0013», «la Preferencia Base-0015»; nunca «Local-0047» a secas. | — |
