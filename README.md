...
En **esta** máquina los 5 skills están enlazados por **junction** (NTFS) desde `~/.claude/skills/` hacia cada `funcionalidades/<n>/skills/<nombre-skill>` — fuente única para editar en vivo, sin pasar por el cache de plugins. Recrear en otra máquina de desarrollo:
