...
description: Agrega, modifica o da de baja una regla del Propósito en .claude/conducta/, eligiendo un momento y una clase de acción compatibles y corriendo el lint. Use when el usuario pide asegurar un comportamiento en un momento del flujo, o al reubicar una pieza cuyo destino es Conducta.
---
