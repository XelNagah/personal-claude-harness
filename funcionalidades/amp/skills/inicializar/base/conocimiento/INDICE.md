...
| Base-0004 | La carpeta `.claude/common/` | Los módulos que usan varios subsistemas y no son de ninguno: qué vive ahí, por qué no son Herramientas (no se invocan, los requiere otro código), cuándo mudar algo, y las dos cosas que arrastra un módulo compartido —tiene que viajar entero y necesita prueba propia—. | [la-carpeta-common.md](la-carpeta-common.md) |
| Base-0005 | El ciclo de vida de un término del glosario | Las dos puntas: una definición que además argumenta por qué la cosa va donde va deja de definir y se vuelve ilegible; y vetar un término cuando el texto ya está barrido solo deja marcas de lint que nadie puede apagar. | [ciclo-de-vida-de-un-termino.md](ciclo-de-vida-de-un-termino.md) |
