...
6. **Reportar** en los tres baldes. Correr el lint (`node .claude/glosario/lint-glosario/lint-glosario.js`) → debe dar limpio sobre el glosario vacío. **No hacer commit** salvo pedido explícito.
