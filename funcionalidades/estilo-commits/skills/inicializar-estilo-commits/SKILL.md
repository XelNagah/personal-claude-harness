...
2. **Asegurar `feedback_estilo_commits.md`** (texto **verbatim** de [PLANTILLA.md](PLANTILLA.md)) y su línea en `memoria/MEMORIA.md`. Si ya existe esa memoria o una equivalente: no duplicar; si difiere, reportar como `divergente` y preguntar.
